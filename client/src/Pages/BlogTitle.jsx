...
// Fallback to localhost if VITE_BASE_URL is not set
...
const BlogTitles = () => {
  ...
  const onSubmitHandler = async (e)=>{
      ...
      try {
          setLoading(true)
          const prompt = `Generate exactly 4 different, catchy, descriptive blog post titles (each 6-12 words long) for a blog about "${input}" in the "${selectedCategory}" category.
Each title MUST be on its own line, starting with "1.", "2.", "3.", "4.".
