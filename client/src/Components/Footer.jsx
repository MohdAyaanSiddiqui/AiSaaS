        ...
        <footer className='bg-black py-12 px-4 sm:px-6 lg:px-8'>
            <div className='w-full max-w-7xl mx-auto'>
                ...
                <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8">
                    <div className="w-full md:w-[45%] lg:w-[35%] flex flex-col items-center md:items-start text-center md:text-left">
                        <div className='w-full max-w-52 h-px mt-8 bg-linear-to-r from-black via-white/25 to-black'></div>
                            <img src={LogoSaaS} alt="Logo" className='h-18 rounded-full' />
                        <p className='text-sm text-white/60 mt-6 max-w-sm leading-relaxed'>
                            We Are Providing You Best Feature With Reasonable Price, Join us For Growth
                        </p>
                    </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className='text-xs text-white/60'>© 2025 AiSaaS</p>
